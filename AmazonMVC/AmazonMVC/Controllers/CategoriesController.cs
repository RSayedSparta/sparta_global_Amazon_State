...
namespace AmazonMVC.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CatagoryID,CatagorytName,CatagoryDescription")] Catagory catagory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CatagoryID,CatagorytName,CatagoryDescription")] Catagory catagory)
        {
            if (ModelState.IsValid)
            {
